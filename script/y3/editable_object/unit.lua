...
---@param direction number 方向
---创建幻象
function unit.create_illusion(illusion_unit, call_unit, player, point, direction)
    game_api.create_illusion(illusion_unit.base(), call_unit.base(), player.base(), point.base(), Fix32(direction))
end
